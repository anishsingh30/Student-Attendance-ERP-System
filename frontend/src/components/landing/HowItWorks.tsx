...
export const HowItWorks: React.FC = () => {
  ...
  return (
    <section id="how-it-works" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-[#F8FAFC] dark:bg-[#09090B] border-b border-slate-200 dark:border-[#27272A]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 relative">
          {steps.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white dark:bg-[#121215] border border-slate-200 dark:border-[#27272A] p-4 sm:p-5 rounded-xl flex flex-col justify-between hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-md transition-all duration-200 relative group"
              >
                ...
                <div>
                  ...
                  <div className="w-9 h-9 rounded-xl bg-slate-50 dark:bg-[#18181B] border border-slate-200 dark:border-[#27272A] flex items-center justify-center text-slate-700 dark:text-zinc-300 mb-3 group-hover:bg-blue-50 dark:group-hover:bg-blue-950/40 group-hover:text-blue-600 dark:group-hover:text-blue-400 group-hover:border-blue-200 dark:group-hover:border-blue-800 transition-colors">
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 dark:border-[#27272A] flex items-center justify-between text-[10px] text-slate-400 dark:text-zinc-500 font-mono">
        ...
        <div className="mt-10 bg-white dark:bg-[#121215] p-5 rounded-xl border border-slate-200 dark:border-[#27272A] shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <span className="px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-[#18181B] text-slate-700 dark:text-zinc-300 text-xs font-mono font-semibold whitespace-nowrap border border-slate-200 dark:border-[#27272A]">
