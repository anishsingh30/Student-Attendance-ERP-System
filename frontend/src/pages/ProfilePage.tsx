...
export const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in pb-12">
      ...
      {/* Main Profile Card */}
      <div className="bg-white dark:bg-[#111111] border border-slate-200 dark:border-[#262626] rounded-xl shadow-xs overflow-hidden">
        
        {/* Header Banner */}
        <div className="bg-gradient-to-r from-blue-700 to-indigo-800 h-32 px-6 flex items-end pb-4 relative">
          <div className="absolute top-4 right-4 flex items-center gap-2">
            <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-white/15 text-white backdrop-blur-xs uppercase font-mono tracking-wider border border-white/20">
              {role} Record
            </span>
          </div>
        </div>
        ...
        <div className="px-6 pb-6 pt-0 relative">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 -mt-12 mb-6">
            <div className="flex items-end gap-4">
              ...
              <div className="relative group">
                <div className="w-24 h-24 rounded-2xl bg-white dark:bg-[#171717] p-1 shadow-md border border-slate-200 dark:border-[#262626] flex-shrink-0 overflow-hidden">
                  {user.profile_photo_url ? (
                    ...
                    <div className="w-full h-full rounded-xl bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 font-bold flex items-center justify-center text-2xl border border-blue-100 dark:border-blue-800/60">
                ...
                <button
                  ...
                  disabled={uploading}
                  className="absolute bottom-1 right-1 p-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white shadow-md transition-all focus:outline-none focus:ring-2 focus:ring-blue-600 cursor-pointer"
                ...
                {user.profile_photo_url && (
                  <button
                    ...
                    disabled={uploading}
                    className="absolute top-1 right-1 p-1 rounded-md bg-rose-600 hover:bg-rose-700 text-white shadow-md transition-all opacity-0 group-hover:opacity-100 cursor-pointer"
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <button
                onClick={logout}
                className="px-3.5 py-2 rounded-lg bg-slate-100 dark:bg-[#171717] hover:bg-rose-50 dark:hover:bg-rose-950/30 text-slate-700 dark:text-[#D4D4D4] hover:text-rose-700 dark:hover:text-rose-400 border border-slate-200 dark:border-[#262626] hover:border-rose-200 dark:hover:border-rose-800 text-xs font-semibold transition-all inline-flex items-center gap-1.5 erp-button cursor-pointer"
              >
          ...
          <div className="border-t border-slate-100 dark:border-[#262626] pt-6">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-[#A3A3A3] mb-4">
              Institutional Credentials
            </h3>

            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              
              <div className="p-3.5 rounded-lg bg-slate-50 dark:bg-[#171717] border border-slate-200 dark:border-[#262626]">
                <div className="flex items-center gap-2 text-slate-500 dark:text-[#A3A3A3] text-xs mb-1">
              ...
              {role === 'student' && (
                <div className="p-3.5 rounded-lg bg-slate-50 dark:bg-[#171717] border border-slate-200 dark:border-[#262626]">
                  ...
                  <p className="text-sm font-semibold text-slate-900 dark:text-white">
                    Semester {user.semester || 5} (Fall Term)
                  </p>
                </div>
              )}
      ...
      <div className="bg-white dark:bg-[#111111] border border-slate-200 dark:border-[#262626] rounded-xl p-6 shadow-xs space-y-4">
        <div className="flex items-center gap-2.5 pb-3 border-b border-slate-100 dark:border-[#262626]">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-[#A3A3A3]">Update your institutional account credentials</p>
          </div>
        </div>
        ...
        <form onSubmit={handleChangePassword} className="space-y-4 max-w-lg">
          <div>
            <label className="block text-xs font-semibold text-slate-700 dark:text-[#D4D4D4] mb-1">Current Password</label>
            <input 
              type="password" 
              required 
              ...
              placeholder="••••••••"
              className="w-full bg-white dark:bg-[#141414] border border-slate-300 dark:border-[#262626] rounded-lg px-3.5 py-2 text-xs text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-[#737373] focus:outline-none focus:ring-2 focus:ring-blue-600"
            />
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-slate-700 dark:text-[#D4D4D4] mb-1">New Password</label>
              <input 
                type="password" 
                required 
                value={newPassword}
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 dark:text-[#D4D4D4] mb-1">Confirm New Password</label>
              <input 
                type="password" 
                required 
